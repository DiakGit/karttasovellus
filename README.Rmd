...
`perhevapaalaskuri` on `shiny`-sovellus, joka tuottaa eriteltyä tietoa huono-osaisuudesta maakunnittain, seutukunnittain tai kunnittain.
...
Voit asentaa perhevapaalaskuri-paketin
